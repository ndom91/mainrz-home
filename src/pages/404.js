...
const FourOhFour = () => {
  return (
    <div className='relative flex items-center justify-center w-full min-h-screen bg-gray-900 bg-opacity-70'>
      <div className='flex flex-col text-gray-500 lg:flex-row lg:space-x-16 lg:space-x-reverse'>
        <div className='order-1 px-2 max-w-md text-sm md:text-base lg:px-0'>
          <header className='mb-6'>
            <h2 className='text-gray-300 text-4xl font-bold leading-none select-none lg:text-6xl'>
              404.
            </h2>
          ...
          <Link href='/'>
            <button className='focus:shadow-outline-green inline px-4 py-2 text-white text-sm font-medium leading-5 bg-newtelco-500 active:bg-newtelco-600 hover:bg-newtelco-700 border border-transparent rounded-lg focus:outline-none shadow uppercase transition-colors duration-150'>
              Back to Homepage
            </button>
          </Link>
        </div>
