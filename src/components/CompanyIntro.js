  ...
  return (
    <section className='body-font text-gray-400 lg:my-36'>
      <div className='container mx-auto px-5 py-24'>
        <div className='flex flex-col items-center mx-auto w-full text-center lg:w-3/4 xl:w-1/2'>
          <svg
          ...
          <div className='inline-block mb-6 mt-8 w-24 h-1 bg-newtelco-500 rounded-xl'></div>
